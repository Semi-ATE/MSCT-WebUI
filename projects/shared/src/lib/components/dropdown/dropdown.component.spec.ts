...
describe('DropdownComponent', () => {
  ...
  it('should show label text', () => {
    const expectedLabel = 'Dropdown Label';
  ...
  describe('initDropdown', () => {
    it('should get initialized value when it called ', () => {
      ...
      const dropdownItems = [{description:'desc 1', value: 1}, {description:'desc 2', value: 2}];
    ...
    it('should support value when items and selectedIndex are optional', () => {
      ...
      const items = [{description:'desc 1', value: 1}, {description:'desc 2', value: 2}];
