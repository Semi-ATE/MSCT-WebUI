...
describe('SystemConsoleComponent', () => {
  ...
  describe('Clear Button', () => {
    it('should be displayed', () => {
      ...
      expect(clearButtons.length).withContext('There should be a unique button with label text "Clear"').toBe(1);
    });
    ...
    it('should clear all messagess if it has been clicked', async () => {
      ...
      expect(entryFound()).toBeFalsy('At the beginning there is no entry with "status, testing"');
  ...
  it('should show an input field', () => {
    const input = debugElement.queryAll(By.css('lib-input'));
  ...
  describe('restoreSettings', () => {
    async function waitProperLoglevelFilterInitialization(): Promise<void> {
    ...
    async function waitUnitlSourceFilterIsInitialized(): Promise<void> {
