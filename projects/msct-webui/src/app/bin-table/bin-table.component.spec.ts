...
describe('BinTableComponent', () => {
  ...
  it('should display bin data', async () => {
    ...
    const tableHeadersElement = debugElement.queryAll(By.css('.tableHeader li'));
    ...
    const tableRowsElement = debugElement.queryAll(By.css('.tableRow li')).map(e => e.nativeElement.innerText);
