import { SiteHead, computeSiteHeadFromNumbers, STDF_RECORD_ATTRIBUTES, stdfGetValue, computePassedInformationForPartFlag, PrrRecord } from './../stdf/stdf-stuff';
...
export class SiteBinInformationComponent implements OnInit, OnDestroy {
  ...
  private updateView(result: Map<SiteHead, PrrRecord>): void {
    const key: SiteHead = computeSiteHeadFromNumbers(this.siteNumber, this.headNumber);
    const record: PrrRecord = result.get(key);
